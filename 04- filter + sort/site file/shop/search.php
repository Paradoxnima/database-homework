<?php
  ...
  $bigger = $_GET['bigger'];
  $smaller = $_GET['smaller'];


  $sql = "SELECT * FROM products WHERE price > $bigger AND price < $smaller";
...
<table class="table table-bordered table-striped text-center">
  <thead>
    <tr>
      ...
      <th>موجودی</th>
      <th>قیمت 
      <i class="fa-sharp fa-solid fa-up-down"></i></a>
      </th>
      <th>وضعیت نمایش</th>
      <th>ویرایش / حدف</th>
    </tr>
...
فیلتر قیمت
  <div class="row">
    <div class="col">
      <input type="text" class="form-control" name="bigger" placeholder="بزرگ تر از">
    </div>
    <div class="col">
      <input type="text" class="form-control" name="smaller" placeholder="کوچک تر از">
    </div>
    <div class="col">
